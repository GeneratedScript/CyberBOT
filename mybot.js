...
client.on('ready', () => {
  ...
  client.user.setGame(">help || Cyber Rules!", "https://go.twitch.tv/generatedscript");
});
...
if (command === "mute") {
  ...
  let modlog = message.guild.channels.find('name', 'bot-logs');
  let muteRole = client.guilds.get(message.guild.id).roles.find('name', 'Muted');
  if (!modlog) return message.reply('I cannot find a bot-logs channel').catch(console.error);
